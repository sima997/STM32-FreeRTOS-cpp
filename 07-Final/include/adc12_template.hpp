...
// --------------------------------------------
template<AdcInstance Instance>
struct Adc12InstanceGuard {
...
public:
     ...
     */
    Adc12(){
        if(Adc12InstanceGuard<Instance>::constructed) {
            __builtin_trap();
        }
        Adc12InstanceGuard<Instance>::constructed = true;
        errorStatus = init();
    }
    ...
    Adc12(const Adc12&) = delete;
    Adc12& operator=(const Adc12&) = delete;
    Adc12(Adc12&&) = delete;
    Adc12& operator=(Adc12&&) = delete;
...
private:
    ...
    static const constexpr uint32_t adc_psc_values[]  = {
