...
template<> struct UartPins<1> {
    ...
    using Rx = Gpio<GpioPort::A, 9, GpioMode::Alt, GpioSpeed::VeryHigh, GpioPull::None, GpioAF::AF7>;
...
// Specialization for Instance = 2:
template<> struct UartPins<2> {
    // Configure pins for ST-Link VCP (PA2 = TX, PA3 = RX, AF7)
    using Tx = Gpio<GpioPort::A, 2, GpioMode::Alt, GpioSpeed::VeryHigh,
                    GpioPull::None, GpioAF::AF7>;
    using Rx = Gpio<GpioPort::A, 3, GpioMode::Alt, GpioSpeed::VeryHigh,
                    GpioPull::None, GpioAF::AF7>;
...
template<> struct UartPins<3> {
    //Configure pins 
    using Tx = Gpio<GpioPort::B, 9, GpioMode::Alt, GpioSpeed::VeryHigh, GpioPull::None, GpioAF::AF7>;
    using Rx = Gpio<GpioPort::B, 8, GpioMode::Alt, GpioSpeed::VeryHigh, GpioPull::None, GpioAF::AF7>;
