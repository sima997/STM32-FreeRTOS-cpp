...
template<> struct I2cPins<1> {
    using SDA = Gpio<GpioPort::B, 9, GpioMode::Alt, GpioSpeed::VeryHigh, GpioPull::None, GpioAF::AF4, GpioOType::OpenDrain>;
    using SCL = Gpio<GpioPort::B, 8, GpioMode::Alt, GpioSpeed::VeryHigh, GpioPull::None, GpioAF::AF4, GpioOType::OpenDrain>;
